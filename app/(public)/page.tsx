  ...
  : [
      {
        ...
        body: "Explore our full range of orchard ciders, traditional perries, and small-batch ales — each one made slowly from our own fruit and hops.",
      },
      {
        icon: ShieldCheck,
        title: "Order securely",
        body: "Checkout with Stripe-powered payment. Choose next-day delivery or collect directly from the farm shop in Ledbury.",
      },
      {
        icon: PackageCheck,
        title: "Delivered in perfect condition",
        body: "We pack every order carefully to protect the bottles. No shake, no breakage — just the same drink we'd pour for ourselves.",
      },
    ];
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center text-white">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
            <GlassWater className="h-3.5 w-3.5 text-harvest-400" />
            {config.brand.location} · Unpasteurised · Est.{" "}
          ...
          <h1 className="font-display mb-6 text-5xl font-bold leading-tight text-balance sm:text-6xl lg:text-7xl">
            Drinks the orchard
            <span className="block italic text-harvest-400">made itself.</span>
          </h1>
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
            {config.brand.tagline}. Slow fermentation, wild yeast, and
            century-old apple varieties you won&apos;t find anywhere else.
          </p>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <h2 className="font-display mb-6 text-4xl font-bold text-white sm:text-5xl">
                  Forty acres of forgotten apple trees.
                </h2>
                ...
                >
                  Meet the cidermaker <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Order before noon for next-day delivery, carefully packed to
                  protect every bottle. Free delivery on orders over £40.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">
                  Living drinks, naturally
                </h4>
                <p className="text-sm text-gray-500">
                  Everything we make is unpasteurised and unfiltered. These are
                  alive, evolving drinks — store cool and enjoy fresh.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  If anything arrives damaged or not to your liking, we replace
                  it. No questions, no fuss — just good service.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden bg-forest-800 py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          <h2 className="font-display mb-4 text-4xl font-bold text-white sm:text-5xl">
            Taste what the orchard actually tastes like.
          </h2>
          <p className="mb-8 text-lg text-forest-300">
            Slow-fermented, unpasteurised, and alive with flavour. Join over
            2,800 customers who&apos;ve discovered honest cider.
          </p>
          <Link
            href="/shop"
          ...
          >
            Shop our drinks <ArrowRight className="h-5 w-5" />
          </Link>
        </div>
      </section>
    </>
